        ...
        public void Seed()
        {
            ...
            var peoples = new Person[]
            {
                new Person() { Address1 = "123 Seattle Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Mount Vernon",
                    ...
                    PhotoFileName = "person-1.jpg", Interests = new List<Interest>() { new Interest() {Name = "Skiing" } } },
                new Person() { Address1 = "123 Olympia Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Marysville",
                    ...
                    PhotoFileName = "person-2.jpg", Interests = new List<Interest>() { new Interest() {Name = "Snorkeling" } } },
                new Person() { Address1 = "123 Shelton Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Burien",
                    ...
                    PhotoFileName = "person-3.jpg", Interests = new List<Interest>() { new Interest() {Name = "Swimming" } } },
                new Person() { Address1 = "123 Bellevue Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Pasco",
                    ...
                    PhotoFileName = "person-4.jpg", Interests = new List<Interest>() { new Interest() {Name = "Skydiving" } } },
                new Person() { Address1 = "123 Spokane Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Sammamish",
                    ...
                    PhotoFileName = "person-5.jpg", Interests = new List<Interest>() { new Interest() {Name = "Spelunking" } } },
                new Person() { Address1 = "123 Vancouver Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Duvall",
                    ...
                    PhotoFileName = "person-6.jpg", Interests = new List<Interest>() { new Interest() {Name = "Reading" }, new Interest() { Name="Surfing" } } },
                new Person() { Address1 = "123 Republic Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Redmond",
                    ...
                    PhotoFileName = "person-7.jpg", Interests = new List<Interest>() { new Interest() {Name = "Programming" }, new Interest() { Name = "Mountain Bike Riding"} } },
                new Person() { Address1 = "123 Bremerton Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Leavenworth",
                    ...
                    PhotoFileName = "person-8.jpg", Interests = new List<Interest>() { new Interest() {Name = "Blogging" }, new Interest() { Name = "Chess" } } },
                new Person() { Address1 = "123 Tacoma Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "White Salmon",
                    ...
                    PhotoFileName = "person-9.jpg", Interests = new List<Interest>() { new Interest() {Name = "Cross Training" } } },
                new Person() { Address1 = "123 Fife Way", Address2 = "Apt 456", State = "WA", Country = "USA", City = "Lynwood",
                    ...
                    PhotoFileName = "person-10.jpg", Interests = new List<Interest>() { new Interest() {Name = "Surgery" },
                    new Interest() { Name = "Trips to Mars" } , new Interest() { Name="Trekking"}, new Interest() { Name= "Tobogganing" }, new Interest { Name = "Deep-Sea Fishing" } } }
            };
